...
def animal_predict(proteins,path,libsvm_path,model=12345, id=1, tmpfile_path=None):
	return predict("animal","Benchmark80A",proteins,path,libsvm_path,model, id, tmpfile_path)

def fungi_predict(proteins,path,libsvm_path,model=12345, id=1, tmpfile_path=None):
	return predict("fungi","Benchmark80F",proteins,path,libsvm_path,model, id, tmpfile_path)

def plant_predict(proteins,path,libsvm_path,model=12345, id=1, tmpfile_path=None):
	return predict("plant","Benchmark80P",proteins,path,libsvm_path,model, id, tmpfile_path)
